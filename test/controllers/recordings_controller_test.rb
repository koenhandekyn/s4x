...
class RecordingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create recording" do
    assert_difference('Recording.count') do
      post recordings_url, params: { recording: { duration: @recording.duration, name: @recording.name, record_at: @recording.record_at, source_uri: @recording.source_uri } }
    end
  ...
  test "should update recording" do
    patch recording_url(@recording), params: { recording: { duration: @recording.duration, name: @recording.name, record_at: @recording.record_at, source_uri: @recording.source_uri } }
